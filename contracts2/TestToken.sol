...
contract Testqwe is ERC20, Ownable {
    // Address List

    address public taxWallet = 0xA4D1E481417bBB1E472152A4ABD99D9E161Ba8f1;

    // Tax System

    uint256 public _feeBuyTotal = 166;

    uint256 public _feeSellTotal = 166;
    ...
    constructor(address router) ERC20("Testqwe", "TQ") {
        uint256 startSupply = 13000 * 10 ** 12 * 10 ** 18;
    ...
    function _transfer(
        ...
        if (msg.sender == owner()) {
            ...
            taxAmount = (amount * _feeSellTotal) / 10000;
            flag = Flag.Sell;
        } else if (from == address(swapRouter)) {
            taxAmount = (amount * _feeBuyTotal) / 10000;
            flag = Flag.Buy;
        } else {
            taxAmount = 0;
        }
